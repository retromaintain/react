...
export default function ReactGPTindex() {
    ...
    <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
      <div className="lg:w-10/12 w-full">
        ...
        <h2 className="title mt-4 xl:w-8/12 lg:w-10/12 text-left w-full font-bold primary-color lg:text-6xl text-3xl lg:leading-10 leading-9">
          <SiOpenai className='inline align-middle mb-4 mr-2'/><span className='text-white'>React</span>-GPT.
        </h2>
        <p className="text-font text-left font-normal text-base leading-6 text-gray-600 mt-6">
          React-GPT it's an Open Source implementation of OpenAI's GPT 3.5 Turbo
          API in React. At it's core it works by fetching data from this API,
          including support for other models like Text-DaVinci-003. The site was
          powered with a PDF export option for document writing such as Essays
          or Articles and Full Markdown support + Code Highlighting.
        </p>
        <div className="flex justify-start mt-2">
          <FaReact
            className="z-5 text-blue-400 text-center inline mr-2 mt-2"
            size={32}
          />
          <SiAxios
          ...
          />
          <SiTailwindcss
            className="z-5 text-blue-400 text-center inline mr-2  my-2"
            size={32}
          />
          <FaNodeJs
